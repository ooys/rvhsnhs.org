                ...
                <div className="columns">
                    <div className="column about-section is-full is-bg-light">
                        <div
                            ...
                            <div className="column findtutor-about-section-text is-full">
                                <div className="badges-section-header">
                                    Badges
                                </div>
                                <div className="badges-section-body">
                                    There are a ton of badges you can earn through your involvment in NHS. Click on a badge to learn more about it and how you can earn it.
                                </div>
                                <br></br>
                                <div className="columns badge-list is-multiline">
                                    <div className="column listed-badge is-one-third">
                                        <a
                                            ...
                                            <img className="badge-pic" src="/images/badges/officer.svg" alt="Officer"></img>
                                        </a>
                                    ...
                                    <div className="column listed-badge is-one-third">
                                        <a
                                            ...
                                            <img className="badge-pic" src="/images/badges/beta_tester.svg" alt="Beta Tester"></img>
                                        </a>
                                        <BadgeModal
                                            active={active}
                                            title="officer"
                                    ...
                                    <div className="column listed-badge is-one-third">
                                        <a
                                            ...
                                            <img className="badge-pic" src="/images/badges/bug_hunter.svg" alt="Bug Hunter"></img>
                                        </a>
                                        <div className="listed-badge-name">
                                            Bug Hunter
                                        </div>
                                    ...
                                    <div className="column listed-badge is-one-third is-offset-2">
                                        <a
                                            ...
                                            <img className="badge-pic" src="/images/badges/overachiever.svg" alt="Overachiever"></img>
                                        </a>
                                        <div className="listed-badge-name">
                                            Overachiever
                                        </div>
                                    ...
                                    <div className="column listed-badge is-one-third">
                                        <a
                                            ...
                                            <img className="badge-pic" src="/images/badges/medal.svg" alt="Volunteer of the Month"></img>
                                        </a>
                                        <div className="listed-badge-name">
