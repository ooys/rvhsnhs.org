            ...
            <div className="page-wrapper" id="index">
                <div className="columns columns-wrapper is-multiline">
                    ...
                    <div className="column about-divider is-bg-shade">
                        <div class="custom-shape-divider-top-1629403421">
                            <svg
                                data-name="Layer 1"
                    ...
                    <div className="column about-divider is-bg-shade">
                        <div class="custom-shape-divider-bottom-1629403947">
                            <svg
                                data-name="Layer 1"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 1200 120"
                    ...
                    <div className="column about-divider is-bg-shade">
                        <div class="custom-shape-divider-top-1629404117">
                            <svg
                                data-name="Layer 1"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 1200 120"
                    ...
                    <div className="column about-divider is-bg-shade">
                        <div class="custom-shape-divider-bottom-1629404241">
                            <svg
                                data-name="Layer 1"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 1200 120"
                    ...
                    <div className="column about-divider is-bg-blue">
                        <div class="custom-shape-divider-top-1629404316">
                            <svg
                                data-name="Layer 1"
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 1200 120"
